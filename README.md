“Neon City Survivor” (Người sống sót ở thành phố Neon) là một cụm từ mang đậm phong cách Cyberpunk — một thể loại khoa học viễn tưởng rất phổ biến trong phim ảnh, truyện tranh và trò chơi điện tử (như game Cyberpunk 2077, phim Blade Runner, hay anime Akira).
...
🧠 CẤU TRÚC DỮ LIỆU 
Cấu trúc	Vai trò
BST	Quản lý vật phẩm (item)
Queue	Nhiệm vụ trong game
Stack	Undo hành động
Priority Queue	Quái vật mạnh xuất hiện trước
Vector	Inventory (túi đồ)
________________________________________
🎯 TÍNH NĂNG GAME
✔ Nhặt đồ
✔ Làm nhiệm vụ
✔ Chiến đấu
✔ Quái vật ưu tiên (boss trước)
✔ Undo hành động
✔ Inventory
✔ Thống kê điểm
...
🧠 2. Cấu trúc dữ liệu
✔ BST
→ quản lý item (tìm nhanh theo ID)
✔ Queue
→ nhiệm vụ theo thứ tự
✔ Stack
→ undo hành động
✔ Priority Queue
→ quái mạnh xuất hiện trước (boss AI)
✔ Vector
→ inventory
________________________________________
🎯 3. Cách chơi
1.	Làm mission → tăng điểm 
2.	Fight monster → nhận điểm lớn 
3.	Nhặt item → tăng sức mạnh 
4.	Undo nếu muốn 
5.	Xem inventory 
________________________________________
🏆 4. Điểm mạnh project
...
•	Có undo 
•	Có inventory 
•	Có nhiều DS đúng yêu cầu môn học 
________________________________________
🚀 ý tưởng dự kiến nếu làm được
•	🔥 Map thế giới (graph) 
•	🔥 Skill system 
•	🔥 Level up nhân vật 
•	🔥 Save/load game 
